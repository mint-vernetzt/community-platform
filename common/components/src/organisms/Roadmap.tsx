      ...
      <div className="mv-bg-blue-50 mv-rounded-lg mv-p-4 @xl:mv-p-6 mv-flex mv-flex-col mv-group">
        ...
        {countRoadmapCards > 3 ? (
          <label
            ...
            className="mv-order-3 mv-mt-4 @lg:mv-mt-6 mv-relative mv-block mv-text-nowrap mv-text-sm mv-font-semibold mv-h-5 mv-text-primary mv-cursor-pointer group-has-[:focus]:mv-border-2 group-has-[:focus]:mv-border-blue-400"
          >
          ...
          <>
            <label
              htmlFor={`collapse-col-${props.id}`}
              className="mv-order-3 mv-mt-4 @lg:mv-mt-6 mv-relative mv-block mv-w-full mv-text-sm mv-font-semibold mv-h-5 mv-text-primary mv-cursor-pointer @md:mv-hidden mv-underline mv-decoration-inherit mv-decoration-auto group-has-[:focus]:mv-border-2 group-has-[:focus]:mv-border-blue-400"
            >
