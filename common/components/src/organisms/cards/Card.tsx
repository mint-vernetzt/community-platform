...
function Card(props: CardProps) {
  ...
  return (
    <div className="mv-w-full mv-h-full mv-bg-white mv-border focus-within:mv-border-2 mv-border-neutral-200 focus-within:mv-border-blue-400 mv-rounded-3xl mv-relative mv-overflow-hidden mv-text-gray-700 mv-flex mv-flex-col mv-items-stretch">
