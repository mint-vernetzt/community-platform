...
function TabBar(props: TabBarProps) {
  ...
  const leftScrollClasses = classNames(
    "mv-absolute mv-left-0 mv-top-0 mv-h-full mv-bg-gradient-to-r mv-from-white mv-flex mv-justify-start mv-items-center",
    showScrollLeft ? "mv-visible" : "mv-invisible"
  );
  const rightScrollClasses = classNames(
    "mv-absolute mv-right-0 mv-top-0 mv-h-full mv-bg-gradient-to-l mv-from-white mv-flex mv-justify-end mv-items-center",
