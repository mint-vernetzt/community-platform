...
function Avatar(props: AvatarProps) {
  ...
  const classes = classNames(
    ...
    "mv-bg-neutral-600 mv-border-neutral-200 mv-flex mv-items-center mv-justify-center mv-rounded-full mv-overflow-hidden mv-shrink-0 mv-text-white mv-font-normal	mv-flex mv-items-center mv-justify-center mv-relative",
    props.to &&
