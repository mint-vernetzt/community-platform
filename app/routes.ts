...
export default [
  ...
  route(
    ...
    "./routes/next/event/$slug/settings.tsx",
    [
      ...
      route(
        ...
        "./routes/next/event/$slug/settings/danger-zone.tsx",
        [
          index("./routes/next/event/$slug/settings/danger-zone/index.tsx"),
          route(
          ...
          route(
            ...
            "./routes/next/event/$slug/settings/danger-zone/delete.tsx"
          ),
        ]
      ),
      route(
      ...
      route(
        ...
        "./routes/next/event/$slug/settings/location.tsx"
      ),
      route(
      ...
      route(
        ...
        "./routes/next/event/$slug/settings/time-period.tsx"
      ),
    ]
  ),
