export const locale = {
  title: "Privacy Policy – MINTvernetzt Community Platform",
  intro: {
    description:
  ...
  contactDataProtectionOfficer: {
    title: "Contact Details and Data Protection Officer",
    description:
    ...
    howToContact:
      'You can reach the Data Protection Officer of matrix gGmbH at <0>{{email}}</0> or by post at the address stated above, with the recipient suffix "Attn: Data Protection Officer".',
  },
  general: {
  ...
  individualProcessingSteps: {
    title: "Individual Processing Activities",
    subline:
      "Below you will be informed about the processing activities carried out on our platform.",
    accessAndUse: {
      title: "1. Accessing and Using the Platform",
      intro:
    ...
    registrationAndProfileManagement: {
      title: "2. Registration and Profile Management",
      subline:
      ...
      changeProfile: "You can edit and change your profile data at any time.",
      dataUsageByUs:
    ...
    videoEmbedding: {
      title: "4. Embedding of Videos",
      subline:
        "We enable the embedding of YouTube videos on our platform. Should these be videos from our YouTube channel, we provide information about the data processing taking place there in this <0>privacy notice</0>.",
      description:
        'For the embedding of videos, we use the so-called "Privacy-Enhanced Mode" of YouTube. In this mode, a cookie is only stored on your device when you play the video. According to YouTube, however, no personal cookie information is stored for the playback of videos in Privacy-Enhanced Mode. You can find <0>further information on Privacy-Enhanced Mode on YouTube here</0>. By playing the video, data is sent to YouTube over which we have no influence.',
      purposes: {
        title: "Purpose(s)",
        description: "The embedding of videos serves to illustrate content.",
      },
      legalBasis: {
        title: "Legal Basis",
        description:
    ...
    emailNotifications: {
      title: "5. Notifications via Email",
      description:
    ...
    contactSupport: {
      ...
      description:
        'You can contact our support via email. To do so, you can either click the "Contact Support" button and your email program will open automatically, or you can write to us directly at <0>{{supportMail}}</0>.',
      purposes: {
        title: "Purpose(s)",
        description:
