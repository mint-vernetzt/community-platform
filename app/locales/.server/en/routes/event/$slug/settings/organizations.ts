export const locale = {
  ...
  content: {
    ...
    own: {
      headline: "Add own organizations",
      intro:
        "Here your own organizations are suggested for you to add as responsible organizations with one click.",
      label: "Add",
    },
    current: {
      headline: "Organizations",
      intro:
        "Here you can see all organizations responsible for the event at a glance.",
      remove: "Remove",
    },
    publish: "Publish",
    hide: "Hide",
