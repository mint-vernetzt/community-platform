export const locale = {
  ...
  faq: {
    ...
    parentAndChildEvents: {
      headline: "Questions about related events (main events, sub-events)",
      qAndAs: {
        explanation: {
          question: "What is a main event? What is a sub-event?",
          answer:
            "<p>When you add sub-events to an event, your event becomes a main event. A main event is an event under which you can bundle several individual events, for example, a conference with multiple workshops.<br /><br />Example:<br /><i>“STEM Day 2026” (Main Event)<br />11:15–13:15 Workshop: Design Thinking for Beginners” (sub-event)<br />14:15–16:15 Networking Meeting Alliance for Women in STEM Professions (sub-event)</i><br /><br />In the edit mode of your event, you can create sub-events within the <b>Event Settings</b> under <b>Related Events</b>, or if you have already created other events, add them directly to your main event. <b>The sub-events must be within the timeframe of the main event and must not yet be published.</b><br /><br />It is not possible to create a sub-event within a sub-event. However, you also have the option to add your event to a main event. The main event must be entirely within the timeframe of your sub-event. If you are not an admin of an event that you want to set as a main event, you cannot add your event directly. In this case, you send a request via the “Request to Add” button to the main event administrator. Only after confirmation will your event be linked as a sub-event.<br /><br />You can see your request until it is confirmed or rejected in the “Main Event” tab under “Pending Request”.<br /><br /><b>Please note</b>: Once your event is published, you can no longer make adjustments to the link to the main event. <b>However</b>: Your main event can be canceled and deleted independently of your sub-event. Your sub-event can then continue to exist as an independent event. Whether it remains or is canceled or deleted too is decided by the administrator during the main event cancellation.</p>",
          featureFlag: "events",
        },
        deleteConnection: {
          question: "Can I remove the link to a main event or sub-events?",
          answer:
            "<p>You can remove the link if your event has not yet been published.<br /><br />To do this, go to the <b>Related Events</b> section within the event settings and click <b>Remove sub-event</b> or <b>Remove main event</b>. Your event will then become independent again.</p>",
          featureFlag: "events",
        },
      },
    },
    ...
    fundings: {
      ...
      qAndAs: {
        ...
        feedback: {
          ...
          answer:
            '<p>Yes, very gladly. Send us an email with the subject: “Funding search“ to <a href="mailto:community@mint-vernetzt.de">community@mint-vernetzt.de</a>.</p><p>We are grateful for any feedback and ideas. This way we can further improve the funding search.</p>',
        },
      },
    },
    sharepic: {
