export const locale = {
  ...
  content: {
    ...
    description:
      'Dein Bestätigungslink ist abgelaufen. Denk daran, dass er nur 24 Stunden gültig ist. Hier kannst Du einen neuen anfordern, indem du Deine E-Mail-Adresse eingibst und auf "Bestätigungslink anfordern" klickst.',
    emailLabel: "E-Mail",
  ...
  errors: {
    requestConfirmation:
      "Beim Anfordern des Bestätigungslinks ist ein Fehler aufgetreten. Bitte versuche es erneut.",
  },
} as const;
