export const locale = {
  ...
  content: {
    ...
    eventTeamMemberInvites: {
      headline_one:
        "Du hast {{count}} offene Teammitglieder-Einladung für ein Event.",
      headline_other:
        "Du hast {{count}} offene Teammitglieder-Einladungen für Events.",
      description:
        "Wenn Du Einladungen bestätigst, wirst du als <0>Event-Teammitglied</0> sichtbar.",
      linkDescription: "Zu meinen Events",
    },
    eventSpeakerInvites: {
      headline_one:
        "Du hast {{count}} offene Speaker:innen-Einladung für ein Event.",
      headline_other:
        "Du hast {{count}} offene Speaker:innen-Einladungen für Events.",
      description:
    ...
    eventParticipantInvites: {
      headline_one:
        "Du hast {{count}} offene Einladung zur Teilnahme an einem Event.",
      headline_other:
        "Du hast {{count}} offene Einladungen zur Teilnahme an Events.",
      description:
        "Wenn Du Einladungen bestätigst, wirst du als <0>Teilnehmer:in</0> sichtbar.",
      linkDescription: "Zu meinen Events",
    },
