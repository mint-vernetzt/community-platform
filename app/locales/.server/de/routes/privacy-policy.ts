export const locale = {
  title: "Datenschutzerklärung – MINTvernetzt Community-Plattform",
  intro: {
    description:
  ...
  contactDataProtectionOfficer: {
    title: "Kontaktdaten und Datenschutzbeauftragte:r",
    description:
    ...
    howToContact:
      "Du erreichst die/den Datenschutzbeauftragte:n der matrix gGmbH unter <0>{{email}}</0> oder postalisch unter der vorgenannten Adresse mit dem Empfängerzusatz „z.H. Datenschutzbeauftragte:r“.",
  },
  general: {
    title: "Allgemeines",
    cookies: {
      title: "1. Cookies und ähnliches",
      explanation: [
  ...
  individualProcessingSteps: {
    ...
    videoEmbedding: {
      title: "4. Einbettung von Videos",
      subline:
        "Wir ermöglichen das Einbetten von YouTube Videos auf unserer Plattform. Sollte es sich hier um Videos von unserem YouTube Kanal handeln, informieren wir über die dort stattfindende Datenverarbeitung in dieser <0>Datenschutzinformation</0>.",
      description:
        "Wir verwenden für das Einbetten von Videos den sogenannten „Erweiterten Datenschutzmodus“ von YouTube. Dabei wird erst dann ein Cookie auf Deinem Gerät gespeichert, wenn Du das Video abspielst. Laut YouTube werden jedoch keine personenbezogenen Cookie-Informationen für die Wiedergabe von Videos im erweiterten Datenschutzmodus gespeichert. Hier findest Du <0>weitere Informationen zum erweiterten Datenschutzmodus bei YouTube</0>. Mit dem Abspielen des Videos werden Daten an YouTube gesendet, auf die wir keinen Einfluss haben.",
      purposes: {
        title: "Zweck(e)",
        description:
    ...
    emailNotifications: {
      title: "5. Benachrichtigungen via E-Mail",
      description:
