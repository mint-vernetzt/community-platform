export const locale = {
  content: {
    title: "Zugehörige Veranstaltungen",
    ...
    joinWaitingList: "Warteliste",
    leaveWaitingList: "Von Warteliste entfernen",
    draft: "Entwurf",
    canceled: "Abgesagt",
  },
  errors: {
    invalidProfileId: "Ungültige Daten",
    invalidEventId: "Ungültige Daten",
