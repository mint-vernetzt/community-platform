...
// TODO: Style NextFooter
function NextFooter() {
  const { t } = useTranslation(["organisms/footer"]);

  return (
    <div className="mv-shadow-md -mv-mb-8">
      <footer className="mv-relative mv-text-sm mv-shadow-[0_8px_24px_-4px_rgba(0,0,0,0.16)] mv-bg-white mv-block">
          ...
          <div className="lg:mv-order-3 mv-container lg:mv-py-6 lg:mv-flex ">
            ...
            <div className="mv-pb-4 mv-pt-8 lg:mv-py-0 lg:mv-w-6/12">
              <ul className="mv-flex mv-flex-col lg:mv-flex-row lg:mv-justify-center mv-gap-4 lg:mv-gap-6">
                <li>
                  <MVLink as="a" to="/imprint" isExternal>
                    {t("meta.imprint")}
                  </MVLink>
                </li>
                <li>
            ...
            <div className="mv-font-bold mv-hidden lg:mv-block">
              <div className="mv-w-48 md:mv-mr-16 xl:mv-mr-20">
                <MVLink
                  to="/"
                  variant="primary"
                  className="mv-flex mv-flex-row mv-items-center mv-mb-3 hover:mv-no-underline"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="42"
            ...
            <div className="mv-py-4 mv-flex mv-flex-col mv-gap-4 lg:mv-py-0 lg:mv-pt-3 lg:mv-flex-row lg:mv-gap-16">
              <div className="">
                ...
                <ul className="mv-flex mv-flex-col lg:mv-justify-center mv-gap-4 lg:mv-gap-1">
                  <li>
                    <MVLink to="/explore/profiles" className="">
                      {t("discover.profiles")}
                    </MVLink>
                  </li>
                  <li>
                    <MVLink to="/explore/organizations" className="">
                      {t("discover.organizations")}
                    </MVLink>
                  </li>
                  <li>
                    <MVLink to="/explore/events" className="">
                      {t("discover.events")}
                    </MVLink>
                  </li>
                  <li>
                    <MVLink to="/explore/projects" className="">
                      {t("discover.projects")}
                    </MVLink>
                  </li>
                </ul>
        ...
        <div className="mv-py-4 mv-bg-primary-400 mv-text-white mv-text-center mv-text-xs mv-font-semibold">
          {t("meta.needHelp")}{" "}
          <MVLink as="a" to="mailto:support@mint-vernetzt.de">
