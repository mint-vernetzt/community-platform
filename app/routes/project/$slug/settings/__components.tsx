...
function ButtonSelectControls(props: PropsWithChildren<{}>) {
  return (
...
function ButtonSelect(props: ButtonSelectProps) {
  ...
  const controls = validChildren.find((child) => {
    return React.isValidElement(child) && child.type === ButtonSelectControls;
  });
...
ButtonSelect.Controls = ButtonSelectControls;
