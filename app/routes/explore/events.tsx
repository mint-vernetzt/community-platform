...
export default function ExploreOrganizations() {
  ...
  return (
    <>
      <section className="mv-container-custom mv-mb-12 mv-mt-5 @md:mv-mt-7 @lg:mv-mt-8 mv-text-center">
      ...
      <section className="mv-container-custom mv-mb-4">
        <Form
          {...getFormProps(form)}
          method="get"
          onChange={(event) => {
      ...
      <div className="mv-container-custom mv-mb-4">
        <hr className="mv-border-t mv-border-gray-200 mv-mt-4" />
      </div>
      <section className="mv-container-custom mb-6">
