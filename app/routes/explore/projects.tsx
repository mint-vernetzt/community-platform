...
export async function loader(args: LoaderFunctionArgs) {
  ...
  for (const project of projects) {
    ...
    let background =
      enhancedProject.backgroundImageMetaData === null
        ? null
        : enhancedProject.backgroundImageMetaData.path;
    ...
    let logo =
      enhancedProject.logoImageMetaData === null
        ? null
        : enhancedProject.logoImageMetaData.path;
    let blurredLogo;
    if (logo !== null) {
...
export default function ExploreProjects() {
  ...
  const [form, fields] = useForm<FilterSchemes>({
    id: `filter-projects-${loaderData.submissionHash}`,
    defaultValue: {
  ...
  const [loadMoreForm, loadMoreFields] = useForm<FilterSchemes>({
    id: `load-more-projects-${loaderData.submissionHash}`,
    defaultValue: {
      ...loaderData.submission.value,
  ...
  const [resetForm, resetFields] = useForm<FilterSchemes>({
    id: `reset-projects-filters-${loaderData.submissionHash}`,
    defaultValue: {
      ...loaderData.submission.value,
      prjFilter: {
        additionalDiscipline: [],
                ...
                <Dropdown.List>
                  {isHydrated ? (
                    <div className="mx-4 my-2">
                      ...
                      >
                        <Input.Label htmlFor="prj-area-search" hidden>
                ...
                {loaderData.selectedDisciplines.map((selectedDiscipline) => {
                  ...
                  return (
                    <ConformForm
                      ...
                      useFormOptions={{
                        id: `delete-filter-${selectedDiscipline}-${loaderData.submissionHash}`,
                        defaultValue: {
                          ...loaderData.submission.value,
                          prjFilter: {
                  ...
                  (selectedAdditionalDiscipline) => {
                    ...
                    return (
                      <ConformForm
                        ...
                        useFormOptions={{
                          id: `delete-filter-${selectedAdditionalDiscipline}-${loaderData.submissionHash}`,
                          defaultValue: {
                            ...loaderData.submission.value,
                            prjFilter: {
                              ...loaderData.submission.value.prjFilter,
                ...
                {loaderData.selectedFormats.map((selectedFormat) => {
                  ...
                  return (
                    <ConformForm
                      key={selectedFormat}
                      useFormOptions={{
                        id: `delete-filter-${selectedFormat}-${loaderData.submissionHash}`,
                        defaultValue: {
                          ...loaderData.submission.value,
                          prjFilter: {
                            ...loaderData.submission.value.prjFilter,
                  ...
                  (selectedSpecialTargetGroup) => {
                    ...
                    return (
                      <ConformForm
                        ...
                        useFormOptions={{
                          id: `delete-filter-${selectedSpecialTargetGroup}-${loaderData.submissionHash}`,
                          defaultValue: {
                            ...loaderData.submission.value,
                            prjFilter: {
                              ...loaderData.submission.value.prjFilter,
                ...
                {loaderData.selectedFinancings.map((selectedFinancing) => {
                  ...
                  return (
                    <ConformForm
                      ...
                      useFormOptions={{
                        id: `delete-filter-${selectedFinancing}-${loaderData.submissionHash}`,
                        defaultValue: {
                          ...loaderData.submission.value,
                          prjFilter: {
                            ...loaderData.submission.value.prjFilter,
