...
function ProjectDetail() {
  ...
  return (
    <Container
      ...
      innerContainerClassName="mv-w-full mv-py-4 mv-px-4 @lg:mv-py-8 @lg:mv-px-8 mv-flex mv-flex-col mv-gap-4 @md:mv-gap-6 @lg:mv-gap-8 mv-mb-14 @sm:mv-mb-[72px] @lg:mv-mb-16 mv-max-w-screen-2xl"
    >
      {/* Back Button Section */}
