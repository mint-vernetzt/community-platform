...
export default async function handleRequest(
  ...
  responseHeaders.set(
    ...
    `default-src 'none'; style-src-attr 'self'; style-src-elem 'self'; font-src 'self'; form-action 'self'; script-src 'self' 'nonce-${nonce}' ; img-src 'self' data: ${process.env.IMGPROXY_URL.replace(
      /https?:\/\//,
      ""
