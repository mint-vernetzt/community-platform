...
function OrganizationPage(props: OrganizationPageProps) {
  return (
    <>
          ...
          <div className="md:flex-1/2 lg:flex-5/12 px-4 pt-10 lg:pt-0">
            <div className="px-4 py-8 lg:p-8 pb-15 md:pb-5 rounded-3xl border border-neutral-400 bg-neutral-200 shadow-lg relative lg:ml-14 lg:-mt-64">
              <div className="flex items-center flex-col">
                <div>Organisatios-Logo</div>
                <h3 className="mt-6 text-5xl mb-1">Matrix gGmbh</h3>
              ...
              <div>
                ...
                <p className="text-md text-neutral-600 mb-2 flex px-4 py-3 bg-neutral-300 rounded-lg text-neutral-600">
                  <span className="icon w-6 mr-4 mt-1">
                    <svg
                      width="12"
                      height="20"
                      viewBox="0 0 12 20"
          ...
          <div className="md:flex-1/2 lg:flex-7/12 px-4 pt-10 lg:pt-20">
            <div className="flex flex-col-reverse lg:flex-row flex-nowrap">
              <div className="flex-auto pr-4 mb-6">
                <h1 className="mb-0">Matrix gGmbh</h1>
              </div>
            ...
            <h3 className="font-bold mb-6 mt-14">Assoziert mit</h3>
