...
const de = {
  ...
  "event/$slug/settings/documents/delete-documents": deDeleteEventDocuments,
  ...
  "event/$slug/settings/events": deConnectEventsWithEvent,
  "event/$slug/settings/general": deGeneralEventSettings,
...
const en = {
  ...
  "event/$slug/settings/documents/delete-documents": enDeleteEventDocuments,
  ...
  "event/$slug/settings/events": enConnectEventsWithEvent,
  "event/$slug/settings/general": enGeneralEventSettings,
