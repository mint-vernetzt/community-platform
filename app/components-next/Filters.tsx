...
function ShowMoreButton(props: { showMore: string; showLess: string }) {
  ...
  return (
    <label className="mv-hidden @lg:mv-block mv-peer mv-cursor-pointer mv-rounded-lg mv-font-semibold mv-h-12 mv-text-sm mv-px-6 mv-py-2.5 mv-border mv-border-transparent mv-text-primary hover:mv-text-primary-700 hover:mv-bg-neutral-50 focus-within:mv-text-primary-700 focus-within:mv-bg-neutral-50 focus-within:mv-ring-2 focus-within:mv-ring-blue-400 active:mv-bg-neutral-100">
      <input
        form="none"
        type="checkbox"
